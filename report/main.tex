...
\newcommand{\reporttitle}{BÁO CÁO ĐỒ ÁN THỰC HÀNH \\ LAB 03}
\newcommand{\reportname}{Phân tích dữ liệu bán lẻ bằng Power BI \\ (Retail Data Warehouse)}
...
\input{content/group_info.tex}

\input{content/overview.tex}

\input{content/data_pipeline.tex}

\input{content/analysis.tex}

\input{content/dicussion.tex}
